            ...
            <div className="flex items-center gap-2">
              {!isEditing ? (
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className={member.canEdit ? "text-white/70 hover:text-white hover:bg-white/10 rounded-full px-4" : "text-white/30 rounded-full px-4 cursor-not-allowed"}
                  title={member.canEdit ? "Edit member" : "You don't have permission to edit this member"}
                >
